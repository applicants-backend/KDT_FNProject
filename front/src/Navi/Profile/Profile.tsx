    ...
    return (
        <div className="profile">
            ...
            <div className="profile-img">
                <img
                    src={UserType === "admin" ? companyImg === null ? "" : companyImg : userImg === null ? "" : userImg}
                    alt='profile-image'
                    onError={defalutImg}
                />
            </div>
            ...
            >
                <div style={{
                    ...
                    <div style={{
                        ...
                        <button className="codeGenerator" style={{ width: "30%", padding: "3%", color: "rgb(85, 105, 255)", border: "1px solid rgb(85, 105, 255)", backgroundColor: "white", borderRadius: "10px" }} onClick={toggleToken}>{showToken ? '초대코드 숨김' : '초대코드 발급'}</button>
