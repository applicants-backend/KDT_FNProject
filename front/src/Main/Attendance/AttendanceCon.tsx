      ...
      UserType === 'user' ? (
        <div className="AttendanceCon">
            <div>
                ...
                <div className="data">{Math.floor(AttendWeek ? AttendWeek /60 : 0)} h</div>
            </div>
            ...
            <div>
                ...
                <div className="data">{Math.floor(AttendMonth ? AttendMonth /60 : 0)} h</div>
            </div> 
            ...
            <div className="category">
                ...
                <div className="data percent" style={{color : "#45a049"}}>{AttendPercent?.toFixed(0)}%</div>
            ...
            (<div>
                ...
                <div className="data percent" style={{color : "rgb(219, 112, 147)"}}>{AttendPercent?.toFixed(0)} %</div>
            ...
            <div className="RowBox">
                <div className="row">
                    ...
                    <div className="data">{Math.floor(AttendWeek ? AttendWeek /60 : 0)}  h / 52 h</div>
                </div> 
